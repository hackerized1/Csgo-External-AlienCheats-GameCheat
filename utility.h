...
bool showmenu;
//
//std::uint32_t get_pid(const std::string& name = "csgo.exe")
//{
...
static uintptr_t get_pid()
{
	BYTE target_name[] = { 'c','s','g','o','.','e','x','e', 0 };
...
namespace hazedumper {
	...
	namespace signatures {
		...
		constexpr ::std::ptrdiff_t find_hud_element = 0x26EE5D20;
